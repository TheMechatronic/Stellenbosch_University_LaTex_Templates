...
\usepackage{Latex/stb-nomencl}%......................... List of symbols 
    \renewcommand*{\UnitLabel}[1]{~[\,\unit{#1}\,]}
\usepackage{Latex/stb-bib}%............................. Bibliography (natbib internally)
    \bibliographystyle{Latex/stb-bib-eng-a}
    \renewcommand\bibfont{\small}
% \usepackage{Latex/stb-titlepage}
...
\title{\bfseries
       \AorE{%-- Afrikaans ------------------------------------------
             Stellenbosch University Master's Report Template\\[1ex]
             \normalfont\small\itshape
             (``Stellenbosch University Master's Report Template'')
            }{%-- English -------------------------------------------
             Stellenbosch University Master's Report Template}}
...
\supervisor{Dr.\ D.\ Engelbrecht}
\cosupervisor{Prof.\ J.\ Smit}
